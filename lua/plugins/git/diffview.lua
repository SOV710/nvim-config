return {
  ...
  opts = {
    ...
    keymaps = {
      ...
      view = {
        { 'n', '<tab>',     function() require('diffview.actions').select_next_entry() end,  { desc = 'Open diff for next file' } },
        { 'n', '<s-tab>',   function() require('diffview.actions').select_prev_entry() end,  { desc = 'Open diff for previous file' } },
        { 'n', 'gf',        function() require('diffview.actions').goto_file_tab() end,      { desc = 'Open file in new tabpage' } },
        { 'n', '<leader>e', function() require('diffview.actions').focus_files() end,        { desc = 'Bring focus to file panel' } },
        { 'n', '<leader>b', function() require('diffview.actions').toggle_files() end,       { desc = 'Toggle file panel' } },
        { 'n', 'g?',        function() require('diffview.actions').help 'view' end,          { desc = 'Open keybind help panel' } },
      },
      file_panel = {
        { 'n', 'j',         function() require('diffview.actions').next_entry() end,         { desc = 'Next file entry' } },
        { 'n', 'k',         function() require('diffview.actions').prev_entry() end,         { desc = 'Previous file entry' } },
        { 'n', '<cr>',      function() require('diffview.actions').select_entry() end,       { desc = 'Open diff for selected entry' } },
        { 'n', 's',         function() require('diffview.actions').toggle_stage_entry() end, { desc = 'Stage / unstage entry' } },
        { 'n', '-',         function() require('diffview.actions').toggle_stage_entry() end, { desc = 'Stage / unstage (alias)' } },
        ...
        { 'n', 'X',         function() require('diffview.actions').restore_entry() end,      { desc = 'Restore entry to left-side state' } },
        ...
        { 'n', '<leader>e', function() require('diffview.actions').focus_files() end,        { desc = 'Bring focus to file panel' } },
        { 'n', '<leader>b', function() require('diffview.actions').toggle_files() end,       { desc = 'Toggle file panel' } },
        { 'n', 'g?',        function() require('diffview.actions').help 'file_panel' end,    { desc = 'Open keybind help panel' } },
      },
      file_history_panel = {
        ...
        { 'n', '<cr>',      function() require('diffview.actions').select_entry() end,       { desc = 'Open diff for selected entry' } },
        { 'n', 'y',         function() require('diffview.actions').copy_hash() end,          { desc = 'Copy commit hash to clipboard' } },
        { 'n', 'g?',        function() require('diffview.actions').help 'file_history_panel' end, { desc = 'Open keybind help panel' } },
      },
    },
  },
}
